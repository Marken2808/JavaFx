...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'B2C', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2022-01-24T17:56:20.555Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-01-24T19:20').should('have.value', '2022-01-24T19:20');
