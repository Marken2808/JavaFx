  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="blogsApp.post.home.createOrEditLabel" data-cy="PostCreateUpdateHeading">
            <Translate contentKey="blogsApp.post.home.createOrEditLabel">Create or edit a Post</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('blogsApp.post.title')}
                id="post-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('blogsApp.post.content')}
                id="post-content"
                name="content"
                data-cy="content"
                type="textarea"
              ...
              />
              <ValidatedField
                label={translate('blogsApp.post.date')}
                id="post-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField id="post-blog" name="blog" data-cy="blog" label={translate('blogsApp.post.blog')} type="select">
                <option value="" key="0" />
                {blogs
              ...
              <ValidatedField label={translate('blogsApp.post.tag')} id="post-tag" data-cy="tag" type="select" multiple name="tags">
                <option value="" key="0" />
                {tags
