    ...
    <Row>
      <Col md="8">
        <h2 data-cy="postDetailsHeading">
          <Translate contentKey="blogsApp.post.detail.title">Post</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="blogsApp.post.title">Title</Translate>
            </span>
          </dt>
          <dd>{postEntity.title}</dd>
          <dt>
            <span id="content">
              <Translate contentKey="blogsApp.post.content">Content</Translate>
            </span>
          </dt>
          <dd>{postEntity.content}</dd>
          <dt>
            <span id="date">
              <Translate contentKey="blogsApp.post.date">Date</Translate>
            </span>
          </dt>
          <dd>{postEntity.date ? <TextFormat value={postEntity.date} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <Translate contentKey="blogsApp.post.blog">Blog</Translate>
          </dt>
          <dd>{postEntity.blog ? postEntity.blog.name : ''}</dd>
          <dt>
            <Translate contentKey="blogsApp.post.tag">Tag</Translate>
          </dt>
          <dd>
            {postEntity.tags
