...
import com.cthtc.repository.BlogRepository;
...
/**
 * REST controller for managing {@link com.cthtc.domain.Blog}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BlogResource {
    ...
    public List<Blog> getAllBlogs() {
        ...
        return blogRepository.findByUserIsCurrentUser(username);
    }
