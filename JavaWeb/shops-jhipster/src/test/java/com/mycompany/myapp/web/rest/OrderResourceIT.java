...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().quantity(DEFAULT_QUANTITY).totalPrice(DEFAULT_TOTAL_PRICE);
        // Add required entity
        Product product;
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().quantity(UPDATED_QUANTITY).totalPrice(UPDATED_TOTAL_PRICE);
        // Add required entity
        Product product;
        if (TestUtil.findAll(em, Product.class).isEmpty()) {
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.quantity(UPDATED_QUANTITY).totalPrice(UPDATED_TOTAL_PRICE);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.quantity(UPDATED_QUANTITY);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.quantity(UPDATED_QUANTITY).totalPrice(UPDATED_TOTAL_PRICE);
