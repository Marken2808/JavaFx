...
class ProductResourceIT {
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        ...
        WishList wishList;
        if (TestUtil.findAll(em, WishList.class).isEmpty()) {
            wishList = WishListResourceIT.createUpdatedEntity(em);
            em.persist(wishList);
            em.flush();
        } else {
            wishList = TestUtil.findAll(em, WishList.class).get(0);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productSize(UPDATED_PRODUCT_SIZE).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
