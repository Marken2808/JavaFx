...
import com.cthtc.domain.Category;
import com.cthtc.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link com.cthtc.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CategoryResource {
    ...
    public ResponseEntity<List<Category>> getAllCategories(
        ...
        Page<Category> page;
        if (eagerload) {
            page = categoryRepository.findAllWithEagerRelationships(pageable);
        } else {
