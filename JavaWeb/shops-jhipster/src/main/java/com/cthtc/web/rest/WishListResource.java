...
import com.cthtc.repository.WishListRepository;
...
/**
 * REST controller for managing {@link com.cthtc.domain.WishList}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WishListResource {
    ...
    public ResponseEntity<WishList> partialUpdateWishList(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, wishList.getId().toString())
        );
    }
