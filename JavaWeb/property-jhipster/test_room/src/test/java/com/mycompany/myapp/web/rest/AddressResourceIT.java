...
class AddressResourceIT {
    ...
    private static final String DEFAULT_NUMBERIC = "AAAAAAAAAA";
    private static final String UPDATED_NUMBERIC = "BBBBBBBBBB";
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getNumberic()).isEqualTo(DEFAULT_NUMBERIC);
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].numberic").value(hasItem(DEFAULT_NUMBERIC)))
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.numberic").value(DEFAULT_NUMBERIC))
    ...
    void putNewAddress() throws Exception {
        ...
        Address testAddress = addressList.get(addressList.size() - 1);
        assertThat(testAddress.getNumberic()).isEqualTo(UPDATED_NUMBERIC);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.street(UPDATED_STREET).county(UPDATED_COUNTY).city(UPDATED_CITY).postcode(UPDATED_POSTCODE);
