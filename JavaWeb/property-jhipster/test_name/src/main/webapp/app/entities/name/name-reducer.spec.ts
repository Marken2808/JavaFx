...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './name.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NAME_LIST actions', async () => {
    ...
    it('dispatches FETCH_NAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NAME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NAME actions', async () => {
      const expectedActions = [
        {
