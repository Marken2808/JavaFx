...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOMMODATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ACCOMMODATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOMMODATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOMMODATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOMMODATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOMMODATION actions', async () => {
      const expectedActions = [
        {
