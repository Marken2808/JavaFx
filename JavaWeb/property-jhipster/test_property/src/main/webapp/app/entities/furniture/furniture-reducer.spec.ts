...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './furniture.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FURNITURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FURNITURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FURNITURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FURNITURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FURNITURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FURNITURE actions', async () => {
      const expectedActions = [
        {
